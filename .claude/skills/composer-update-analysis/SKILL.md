---
name: composer-update-analysis
description: This skill should be used when the user wants to analyze Composer dependencies for available updates. It runs composer outdated for both API and APP services, identifies packages that can be safely updated (same major version), fetches changelogs from GitHub, and provides a comprehensive analysis with recommendations. Use this skill when users ask about dependency updates, outdated packages, or want to review what can be updated in their Composer dependencies.
---
